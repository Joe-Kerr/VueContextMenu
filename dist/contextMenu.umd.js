...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/node_modules/cats4vue/src/index.js
/*
Eg:
const defs = {
	prop: {
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/src/directive.js
var listeners = [];
...
function insertedProxy(vuex, namespace) {
  return function inserted(el, context) {
    ...
    var RIGHT = 3;
    var LEFT = 1;
    var mouse = typeof context.modifiers === "undefined" ? RIGHT : typeof context.modifiers.left !== "undefined" ? LEFT : RIGHT;
...
function installDirective(Vue, vuex, namespace) {
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/node_modules/vuex-heman/src/getters.js
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/node_modules/vuex-heman/src/mutations.js
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/node_modules/vuex-heman/src/actions.js
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/node_modules/vuex-heman/src/index.js
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/src/store/index.js
...
/* harmony default export */ var src_store = ({
  ...
  getters: {
    ...
    context: function context(state) {
  ...
  actions: {
    open: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee(store, data) {
    ...
    close: function () {
      ...
      /*#__PURE__*/
      regenerator_default.a.mark(function _callee2(store) {
...
// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js?{"cacheDirectory":"node_modules/.cache/vue-loader","cacheIdentifier":"76cc857b-vue-loader-template"}!./node_modules/vue-loader/lib/loaders/templateLoader.js??vue-loader-options!./node_modules/cache-loader/dist/cjs.js??ref--0-0!./node_modules/vue-loader/lib??vue-loader-options!./projects/plugins/contextMenu/src/ui/index.vue?vue&type=template&id=397d5706&
var render = function () {var _vm=this;var _h=_vm.$createElement;var _c=_vm._self._c||_h;return (_vm.active)?_c('div',{ref:"contextMenu",style:({position: 'absolute', left: _vm.x+'px', top: _vm.y+'px', backgroundColor: 'white'})},[_vm._t("default",null,{"close":_vm.closeByChild,"onResize":_vm.preventOutOfBounds,"context":_vm.context})],2):_vm._e()}
var staticRenderFns = []


// CONCATENATED MODULE: ./projects/plugins/contextMenu/src/ui/index.vue?vue&type=template&id=397d5706&

// CONCATENATED MODULE: ./node_modules/cache-loader/dist/cjs.js??ref--12-0!./node_modules/thread-loader/dist/cjs.js!./node_modules/babel-loader/lib!./projects/plugins/contextMenu/src/ui?vue&type=script&lang=js&
/* harmony default export */ var ui_vue_type_script_lang_js_ = ({
  props: ["menu"],
  name: "context-menu",
  computed: {
    active: function active() {
      var name = this.namespace + "/active";
      return this.$store.getters[name] === this.menu;
    },
    context: function context() {
      var name = this.namespace + "/context";
      return this.$store.getters[name];
    },
    rawPosition: function rawPosition() {
      var name = this.namespace + "/position";
      return this.$store.getters[name];
    }
  },
  watch: {
  ...
  methods: {
    closeByModal: function closeByModal() {
      var name = this.namespace + "/close";
      this.$store.dispatch(name);
    },
    closeByChild: function closeByChild() {
      var closeMenu = this.closeByModal;
      closeMenu();
      this.modalStop();
    },
    ...
    preventOutOfBounds: function preventOutOfBounds() {
      var _this$rawPosition = this.rawPosition,
          x = _this$rawPosition.x,
          y = _this$rawPosition.y;
      var el = this.$refs.contextMenu;
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/src/ui?vue&type=script&lang=js&
 /* harmony default export */ var src_ui_vue_type_script_lang_js_ = (ui_vue_type_script_lang_js_); 
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/src/ui/index.vue
...
var component = normalizeComponent(
  src_ui_vue_type_script_lang_js_,
  render,
  staticRenderFns,
  false,
  null,
...
// CONCATENATED MODULE: ./projects/plugins/contextMenu/src/index.js
...
function parseConfig() {
  ...
  var parsed = cats4Vue.configParser(config, defaults);
  var modalService = parsed.modalService;

  if (modalService !== null) {
    if (_typeof(modalService) !== "object" || typeof modalService.start === "undefined" || typeof modalService.start !== "function" || typeof modalService.stop === "undefined" || typeof modalService.stop !== "function") {
...
function installComponent(comp, Vue, options) {
  ...
  cats4Vue.componentOptionsWriter(comp, {
    $_contextMenus_namespace: options.namespace,
    $_contextMenus_modal: options.modalService
  });
...
var installer = {
  install: function install(Vue, config) {
    ...
    installComponent(ui, Vue, options);
  }
};
/* harmony default export */ var contextMenu_src = (installer);
...
/* harmony default export */ var entry_lib = __webpack_exports__["default"] = (contextMenu_src);
